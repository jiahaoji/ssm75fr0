  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 1);borderRadius:10px">
        <h1 class="h1" style="color:rgba(128, 151, 186, 1);fontSize:28px;">在线网络教学系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="教工号" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.jiaogonghao" autocomplete="off" placeholder="教工号" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
			...
			<el-form-item label="院系" class="input" v-if="tableName=='jiaoshi'">
			...
			<el-form-item label="班级" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.banji" autocomplete="off" placeholder="班级" type="text" />
												...
												<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
			   <div class="label">所教科目</div>
			   <div class="input-container">
			     <input v-model="ruleForm.suojiaokemu" class="input" type="text" placeholder="所教科目">
			   </div>
			 </div> -->
			<el-form-item label="所教科目" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.suojiaokemu" autocomplete="off" placeholder="所教科目" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='jiaoshi'" class="input-group">
...
export default {
  ...
  methods: {
    ...
    // 注册
    login() {
                              if((!this.ruleForm.jiaogonghao) && `jiaoshi` == this.tableName){
        this.$message.error(`教工号不能为空`);
        return
      }
        ...
        return
                                                                        ...
                                                                        if(`jiaoshi` == this.tableName && this.ruleForm.dianziyouxiang&&(!this.$validate.isEmail(this.ruleForm.dianziyouxiang))){
        ...
        return
                                                                        ...
                                                                        if(`xuesheng` == this.tableName && this.ruleForm.dianziyouxiang&&(!this.$validate.isEmail(this.ruleForm.dianziyouxiang))){
        this.$message.error(`电子邮箱应输入邮件格式`);
        return
      }
                                                                                                                                                                                                                        this.$http({
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20210119/a059968d397a458c8ce243ec37b9d4bd.jpg");
		height: 100vh;
